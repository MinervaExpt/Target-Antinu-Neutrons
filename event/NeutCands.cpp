...
namespace NeutronCandidates{
  ...
  doubleBranchMap GetBranchDoubleMap(){
    ...
    return {{"SetTotE",{"_BlobTotalE"}},{"SetBegPos",{"_BlobBegX","_BlobBegY","_BlobBegZ"}},{"SetEndPos",{"_BlobEndX","_BlobEndY","_BlobEndZ"}}, {"SetTopMCMom",{"_BlobMCTopTrackPx","_BlobMCTopTrackPy","_BlobMCTopTrackPz","_BlobMCTopTrackE"}}};//, {"SetTopMCPos",{"_BlobMCTopTrackX","_BlobMCTopTrackY","_BlobMCTopTrackZ","_BlobMCTopTrackT"}}, };
  }
